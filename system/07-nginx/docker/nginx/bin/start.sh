...
[ ! -z "${B2C_CERT_FILE}" ]             && sed -i "s/B2C_CERT_FILE/${B2C_CERT_FILE}/" /etc/nginx/conf.d/default_ssl.conf
[ ! -z "${B2C_CERT_KEY}" ]              && sed -i "s/B2C_CERT_KEY/${B2C_CERT_KEY}/" /etc/nginx/conf.d/default_ssl.conf
...
[ ! -z "${B2B_CERT_FILE}" ]             && sed -i "s/B2B_CERT_FILE/${B2B_CERT_FILE}/" /etc/nginx/conf.d/b2b_ssl.conf
[ ! -z "${B2B_CERT_KEY}" ]              && sed -i "s/B2B_CERT_KEY/${B2B_CERT_KEY}/" /etc/nginx/conf.d/b2b_ssl.conf
